...
<head>
    ...
    <!-- FullCalendar -->
    <link href='../../managerpages/vendor/fullcalendar-3.10.0/fullcalendar.css' rel='stylesheet' media="all" />
...
<body class="animsition">
    ...
    <script src="../../managerpages/vendor/select2/select2.min.js"></script>

    <!-- full calendar requires moment along jquery which is included above -->
    <script src="../../managerpages/vendor/fullcalendar-3.10.0/lib/moment.min.js"></script>
    <script src="../../managerpages/vendor/fullcalendar-3.10.0/fullcalendar.js"></script>
